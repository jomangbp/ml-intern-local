"""Quick test for IMU-1 Style architecture"""
...
import torch
from src.gemma4v2.imu1_config import IMU1Config
from src.gemma4v2.imu1_model import IMU1Model, create_imu1_model


def test_imu1():
    """Test IMU-1 model with all 5 techniques"""
    config = IMU1Config()
    
    print("\n" + "="*60)
    print("IMU-1 Configuration")
    print("="*60)
    ...
    model = create_imu1_model(config)
